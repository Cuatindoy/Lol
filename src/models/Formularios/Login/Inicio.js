...
const Inicio = () => {
    return (
        ...
        <div className="cover">
          <div className="front">
            <img src="https://1.bp.blogspot.com/-OGihJWuMZTk/XMtgjJdqR6I/AAAAAAAAACM/hSZtIOMzlJ8YhKCCaHfokooppCx8h18rACLcBGAs/s1600/depositphotos_13767625-stock-photo-different-animals-collage.jpg" alt="" />
          </div>
        </div>
        <form action="#">
